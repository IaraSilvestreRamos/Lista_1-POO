...
public class HeartRatesTest {
	...
	public static void main(String[] args) {
		...
		System.out.printf("\nFrequencia Cardiaca Alvo: %.0f",heart.FrequenciaAlvo(heart.Calculomaxima(heart.Idade(heart.getAno(), anoatual, mesatual, diaatual))));
		
		System.out.printf(" Até %.0f",heart.FrequenciaAlvo2(heart.Calculomaxima(heart.Idade(heart.getAno(), anoatual, mesatual, diaatual))));
		teclado.close();

...
public class HealthProfile {
	...
	public double Alvo1(double FrequenciaCardiaca){
		return (FrequenciaCardiaca * 0.5);
	}
	public double Alvo2(double FrequenciaCardiaca){
		return (FrequenciaCardiaca * 0.85);
	}
	
	public void IMC(double peso, double altura){
		double kg = peso * 0.453592;
		double alturaT = altura * 0.0254;
		double IMC = (kg)/(alturaT*alturaT);
		System.out.printf("\nSeu IMC: %.2f", IMC);
